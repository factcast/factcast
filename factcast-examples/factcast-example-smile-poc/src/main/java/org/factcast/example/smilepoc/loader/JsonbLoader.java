...
public class JsonbLoader {
  ...
  /**
   * Streams the CSV directly to Postgres via COPY. JSONB columns accept text JSON, so the file goes
   * through unchanged. Returns elapsed nanoseconds and rows loaded.
   */
