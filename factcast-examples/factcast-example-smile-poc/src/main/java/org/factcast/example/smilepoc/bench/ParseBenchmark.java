...
/**
 * Pre-fetches a fixed set of rows into memory, then times only the Java-side parse step:
 * text JSON String → JsonNode (variant A) vs SMILE byte[] → JsonNode (variant B).
 */
@Slf4j
@Component
