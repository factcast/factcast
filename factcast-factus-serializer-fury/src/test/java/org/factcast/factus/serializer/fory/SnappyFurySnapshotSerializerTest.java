...
class SnappyFurySnapshotSerializerTest {

  @InjectMocks private SnappyFurySnapshotSerializer underTest;
  ...
  class WhenIding {
    ...
    @Test
    void wraps() {
      Assertions.assertThat(underTest.id()).isEqualTo(SnapshotSerializerId.of("snappyfury"));
    }
  }
}
