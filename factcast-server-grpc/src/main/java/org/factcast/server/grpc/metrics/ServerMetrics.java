...
public interface ServerMetrics {
  ...
  static ServerMetrics forTest() {
    return new ServerMetrics() {
      ...
      @Override
      public <E extends Exception> void timed(OP operation, Class<E> exceptionClass, RunnableWithException<E> fn) throws E {

      }

      @Override
      public <E extends Exception> void timed(OP operation, Class<E> exceptionClass, Tags tags, RunnableWithException<E> fn) throws E {
      ...
      @Override
      public <R, E extends Exception> R timed(OP operation, Class<E> exceptionClass, SupplierWithException<R, E> fn) throws E {
        return null;
      }

      @Override
      public <R, E extends Exception> R timed(OP operation, Class<E> exceptionClass, Tags tags, SupplierWithException<R, E> fn) throws E {
        return null;
      }
