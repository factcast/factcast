...
class AbstractRedisTxManagedProjectionTest {
  ...
  //      verify(redisson)
  //          .getBucket(underTest.redisKey() + "_state_tracking",
  // FactStreamPositionCodec.INSTANCE);
  //    }
  //  }
  //
  //  @Nested
  ...
  //      // unfortunately, TransactionOptions do not implement hashcode/equals, so we have to
  // compare
  //      // field by field
  ...
  //      AbstractRedisTxProjection underTest = new
  // ProjectionWithBulkSet(mock(RedissonClient.class));
