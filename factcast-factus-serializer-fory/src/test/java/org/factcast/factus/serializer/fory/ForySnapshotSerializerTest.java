...
import org.factcast.factus.serializer.fory.testjson.*;
import org.junit.jupiter.api.*;

class ForySnapshotSerializerTest {
  ...
  private final ForySnapshotSerializer underTest = new ForySnapshotSerializer();
  private final ForySnapshotSerializer lz4UnderTest = new LZ4ForySnapshotSerializer();

  @Test
  void hasId() {
    Assertions.assertThat(underTest.id().name()).isEqualTo("fory");
    Assertions.assertThat(lz4UnderTest.id().name()).isEqualTo("lz4fory");
  }
