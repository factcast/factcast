...
public interface StreamObserver {
  ...
  default BatchFactObserver asBatch() {
    if (this instanceof BatchFactObserver) return (BatchFactObserver) this;
    if (this instanceof FactObserver) return new BatchFactObserver.Adapter((FactObserver) this);
