...
public abstract class AbstractJdbcManagedProjection extends AbstractJdbcProjection
    implements ManagedProjection {

  protected AbstractJdbcManagedProjection(@NonNull DataSource dataSource) {
    super(dataSource, ProjectionType.MANAGED);
  }

  protected AbstractJdbcManagedProjection(
