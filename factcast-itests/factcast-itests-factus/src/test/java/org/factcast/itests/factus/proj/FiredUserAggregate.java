...
/**
 * only "fired" when it is the sacked user of a {@link UserFired}, never when it is merely the actor
 * (sacker), even though the fact carries both ids as aggregate ids.
 */
