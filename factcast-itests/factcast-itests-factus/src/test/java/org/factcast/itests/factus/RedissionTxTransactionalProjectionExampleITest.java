...
@Slf4j
public class RedissionTxTransactionalProjectionExampleITest extends AbstractFactCastIntegrationTest {
    ...
    void renameMe() {
        ...
        val uut = new RedissionTxTransactionalProjectionExample.UserNames(redissonClient);
        factus.update(uut);
