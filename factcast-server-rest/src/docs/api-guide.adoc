...
=== SSE stream of facts
Here, you can subscribe to a Server-Sent-Events stream of facts machting the specification passed. This resource is recommended if you have many facts or server side http-caching is turned off. 
