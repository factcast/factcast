...
In order to run a simple example FactCast server, you could enter the project **factcast-examples/factcast-example-server**, see link:../fatjar[fatjar]
...
xref:ports.adoc[Read more on Ports]