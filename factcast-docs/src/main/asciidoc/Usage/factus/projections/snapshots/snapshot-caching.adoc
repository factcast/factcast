...
Refer to the xref:../../../../Setup/properties.adoc#inmem-snapshots[In-Memory Properties] for configuration details.
...
Refer to the xref:../../../../Setup/properties.adoc#inmemanddisk-snapshots[In-Memory and Disk Properties] for more
information.
...
For further details, see the xref:../../../../Setup/properties.adoc#redissnapshots[Redis Properties].
...
For further details, see the xref:../../../../Setup/properties.adoc#jdbc-snapshots[JDBC Properties].
...
For further details, see the xref:../../../../Setup/properties.adoc#mongodb-snapshots[Mongo Properties].