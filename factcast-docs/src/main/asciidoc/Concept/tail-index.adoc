...
In general, xref:fact.adoc#read-subscribe[subscriptions] may consist of two possible phases:
...
Tail index rotation is configurable and described in xref:../Setup/properties.adoc#performance--reliability[the configuration properties].
...
See the xref:../Setup/properties.adoc#performance--reliability[recommendations of the configuration section] for sensible values
