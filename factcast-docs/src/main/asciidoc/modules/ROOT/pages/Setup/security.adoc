...
If FactCast misses a secret for a configured account on startup, it does not fail startup but logs a warning. The same
applies if a secret is defined for a non-existing account.
...
see
module https://github.com/factcast/factcast/tree/main/factcast-examples/factcast-example-server-basicauth[examples/factcast-example-server-basicauth]
for an example
...
see
module https://github.com/factcast/factcast/tree/main/factcast-examples/factcast-example-client-basicauth[examples/factcast-example-client-basicauth]
for an example
