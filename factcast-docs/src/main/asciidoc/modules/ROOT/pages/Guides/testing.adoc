...
extension is framework-agnostic.
====


== Introduction

An event-sourced application usually performs xref:ROOT:Concept/index.adoc[two kinds of interactions] with the FactCast
server:
...
Factus API has xref:ROOT:Usage/factus/projections/types/index.adoc[explicit support for this concept].
...
xref:ROOT:Usage/factus/projections/atomicity/index.adoc[see here]) this test approach can get challenging.
...
Unit testing this projection is much easier, as there are no external dependencies. We use `Fact` objects as input and
...
https://github.com/factcast/factcast/tree/main/factcast-itests/factcast-itests-doc/src/test/java/org/factcast/itests/docexample/factcastlowlevel/UserEmailsProjectionTest.java[The full unit test]
...
FactCast xref:ROOT:Usage/factus/testing.adoc[provides a Junit5 extension] which starts a FactCast server
...
For details of the FactCast low-level API please refer to xref:ROOT:Usage/lowlevel/java/index.adoc[the API documentation].
...
- https://github.com/factcast/factcast/tree/main/factcast-itests/factcast-itests-doc/src/main/java/org/factcast/itests/docexample/factus/event/UserAdded.java[`UserAdded`]
  and
...
xref:ROOT:Usage/factus/introduction.adoc[here].
...
As projection type we decided for a xref:ROOT:Usage/factus/projections/types/local-managed-projection.adoc[`LocalManagedProjection`]
which is intended for self-managed, in-memory use cases. See xref:ROOT:Usage/factus/projections/types/index.adoc[here] for
...
found https://github.com/factcast/factcast/tree/main/factcast-itests/factcast-itests-doc/[here].
