...
We suggest to check out the "Projections" section of the [Factus API docs](xref:../Usage/factus/projections/index.adoc)
...
[Snapshot Projection documentation](xref:../Usage/factus/projections/types/snapshot-projections.adoc)
...
- **Data consistency**: when fetched, the Snapshot Projection ensures to return the most recent representation of the
  ...
  [Optimistic Locking](xref:../Usage/factus/optimistic-locking.adoc) section for further details.
...
- **Maintainability**: the projection allows to change the business logic of the event handlers, to create new data
  ...
  [documentation](xref:../Usage/factus/projections/snapshots/index.adoc#serials).
...
[Aggregate documentation](xref:../Usage/factus/projections/types/aggregates.adoc)
...
[Managed Projection documentation](xref:../Usage/factus/projections/types/managed-projection.adoc)
...
- **Maintainability**: a managed projection enables the construction of derived views that can potentially be queried
  ...
  [documentation](xref:../Usage/factus/projections/snapshots/index.adoc#serials). The full event-stream will then be
  re-consumed on the subsequent updates, to rebuild the derived views.

### Local Managed Projection

[Local Managed Projection documentation](xref:../Usage/factus/projections/types/local-managed-projection.adoc)
...
[Subscribed Projection documentation](xref:../Usage/factus/projections/types/subscribed-projection.adoc)
...
- **Maintainability**: in terms of maintainability, a Subscribed Projection is similar to a Managed Projection, as it
  ...
  the [documentation](xref:../Usage/factus/projections/snapshots/index.adoc#serials). The full event-stream will then be
...
[Local Subscribed Projection documentation](xref:../Usage/factus/projections/types/local-subscribed-projection.adoc)
