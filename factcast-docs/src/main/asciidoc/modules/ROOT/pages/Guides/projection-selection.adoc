= Hitchhiker's Guide To Projection Selection
:icons: font
...
We suggest to check out the "Projections" section of the xref:ROOT:Usage/factus/projections/index.adoc[Factus API docs]
...
xref:ROOT:Usage/factus/projections/types/snapshot-projections.adoc[Snapshot Projection documentation]
...
- **Data consistency**: when fetched, the Snapshot Projection ensures to return the most recent representation of the
  ...
  xref:ROOT:Usage/factus/optimistic-locking.adoc[Optimistic Locking] section for further details.
...
- **Maintainability**: the projection allows to change the business logic of the event handlers, to create new data
  ...
  xref:ROOT:Usage/factus/projections/snapshots/index.adoc#serials[documentation].
...
xref:ROOT:Usage/factus/projections/types/aggregates.adoc[Aggregate documentation]
...
xref:ROOT:Usage/factus/projections/types/managed-projection.adoc[Managed Projection documentation]
...
- **Maintainability**: a managed projection enables the construction of derived views that can potentially be queried
  ...
  xref:ROOT:Usage/factus/projections/snapshots/index.adoc#serials[documentation]. The full event-stream will then be
  re-consumed on the subsequent updates, to rebuild the derived views.

=== Local Managed Projection

xref:ROOT:Usage/factus/projections/types/local-managed-projection.adoc[Local Managed Projection documentation]
...
xref:ROOT:Usage/factus/projections/types/subscribed-projection.adoc[Subscribed Projection documentation]
...
- **Maintainability**: in terms of maintainability, a Subscribed Projection is similar to a Managed Projection, as it
  ...
  the xref:ROOT:Usage/factus/projections/snapshots/index.adoc#serials[documentation]. The full event-stream will then be
...
xref:ROOT:Usage/factus/projections/types/local-subscribed-projection.adoc[Local Subscribed Projection documentation]
...
Check the following xref:ROOT:Usage/factus/tips.adoc[guide] regularly, as it is updated with tips to
