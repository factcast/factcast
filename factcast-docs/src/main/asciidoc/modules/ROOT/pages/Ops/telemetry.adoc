...
The telemetry events are emitted using a dedicated internal https://github.com/google/guava/wiki/EventBusExplained[Guava EventBus].
...
You can check out the full example in the https://github.com/factcast/factcast/blob/main/factcast-examples/factcast-example-server-telemetry[factcast-example-server-telemetry]
