...
be found in the `factcast-store` module under https://github.com/factcast/factcast/blob/main/factcast-store/src/main/resources/db/changelog/factcast/issue2479/date2serial_for_existing_events.sql[`src/main/resources/db/changelog/factcast/issue2479/date2serial_for_existing_events.sql`].
...
For now, we have decided to disable the `fastupdate` setting via https://github.com/factcast/factcast/blob/main/factcast-store/src/main/resources/db/changelog/factcast/issue3755/disable_fast_update.sql[`src/main/resources/db/changelog/factcast/issue3755/disable_fast_update.sql`]
...
https://www.postgresql.org/docs/15/runtime-config-autovacuum.html[Automatic Vacuuming].
