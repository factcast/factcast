...
tool xref:ROOT:Usage/lowlevel/cli/index.adoc[factcast-schema-cli] you can use. It turns raw data files (Json-Schema,
...
An example can be
found https://github.com/factcast/factcast/tree/main/factcast-examples/factcast-example-server/src/main/resources[here]
which is generated from the module 'factcast-examples/factcast-example-schema-registry/'

See the xref:ROOT:Setup/properties.adoc[Properties]-Section on how to configure this.