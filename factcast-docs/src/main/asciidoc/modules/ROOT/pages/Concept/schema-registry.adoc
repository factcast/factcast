...
tool xref:../Usage/lowlevel/cli/index.adoc[factcast-schema-cli] you can use. It turns raw data files (Json-Schema,
...
See the xref:../Setup/properties.adoc[Properties]-Section on how to configure this.