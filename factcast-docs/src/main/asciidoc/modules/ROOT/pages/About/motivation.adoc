...
- https://geteventstore.com/[Greg Young's EventStore – The open-source, functional database with Complex Event Processing in JavaScript.]
- https://www.lightbend.com/platform/development/lagom-framework[Lagom - Opinionated microservice framework]
- http://doc.akka.io/docs/akka/current/scala/persistence.html[Akka persistence]
- http://www.axonframework.org/[Axon Framework – Java Framework for scalable and high-performance applications.]
- https://kafka.apache.org/[Kafka – for building real-time data pipelines and streaming apps]
- http://eventuate.io/[The Eventuate™ Platform ]
- https://github.com/fuinorg/event-store-commons[event-store-commons – a common event store Java interface ]
- https://github.com/vlingo[vlingo]
