...
to set the role of this instance to readOnly (see xref:../../Setup/deployment-options.adoc[readonly deployment]).
...
The UI uses spring-security. Some helpful settings are documented link:../security[here].
