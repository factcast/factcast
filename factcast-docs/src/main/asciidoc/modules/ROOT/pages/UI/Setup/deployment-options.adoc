...
to set the role of this instance to readOnly (see xref:ROOT:Setup/deployment-options.adoc[readonly deployment]).
...
The UI uses spring-security. Some helpful settings are documented
xref:ROOT:UI/Setup/security.adoc[here].
