...
Atomic projections only make sense in terms of:
 xref:Usage/factus/projections/types/managed-projection.adoc[managed projections] and for
 xref:Usage/factus/projections/types/subscribed-projection.adoc[subscribed projections].
...
* xref:Usage/factus/projections/atomicity/spring-transactional-projections.adoc[data stores supported by Spring Transaction Management] (e.g. JDBC / MongoDB / Cassandra)
* Redis
  * via xref:Usage/factus/projections/atomicity/redis-transactional-projections.adoc[transactions]
...
[NOTE]
====
Bulk processing only takes place xref:../../../../Concept/index.adoc[in the `catchup` phase].
====
