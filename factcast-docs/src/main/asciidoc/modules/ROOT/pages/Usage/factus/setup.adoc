...
As it relies on the excellent https://redisson.org/[Redisson] library, all you need is to add the corresponding redis configuration to your project.
See https://github.com/redisson/redisson/tree/master/redisson-spring-boot-starter[the Redisson documentation].