...
details, have a look at xref:ROOT:Usage/factus/projections/index.adoc[Projections].
...
please https://github.com/factcast/factcast/issues/new/choose[open an issue on GitHub].

If you want to have more control and don't want to opt in to Factus, you can have a look at the lower-level FactCast
API. See the xref:ROOT:Usage/lowlevel/index.adoc[Lowlevel] section instead.
