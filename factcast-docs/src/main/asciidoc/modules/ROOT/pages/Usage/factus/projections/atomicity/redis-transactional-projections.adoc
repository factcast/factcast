...
A _Redis transactional projection_ is a xref:ROOT:Usage/factus/projections/atomicity/index.adoc[transactional projection]
based on https://www.javadoc.io/doc/org.redisson/redisson/latest/org/redisson/api/RTransaction.html[Redisson RTransaction].

Compared to a xref:ROOT:Usage/factus/projections/atomicity/spring-transactional-projections.adoc[Spring transactional projection], a _Redis transactional projection_ is more lightweight since
...
A _Redis transactional projection_ can be a xref:ROOT:Usage/factus/projections/types/managed-projection.adoc[managed-] or
a xref:ROOT:Usage/factus/projections/types/subscribed-projection.adoc[subscribed] projection and is defined as follows:
...
A full example can be found in xref:ROOT:Usage/factus/projections/example/example-redis-tx.adoc[Redis transactional projections].
