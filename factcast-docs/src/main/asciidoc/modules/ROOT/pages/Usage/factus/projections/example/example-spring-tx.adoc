...
| `public WriterToken acquireWriteToken(@NonNull Duration maxWait)` | coordinates write access to the projection, see xref:Usage/factus/projections/types/managed-projection.adoc[managed-projection] for details
|===
