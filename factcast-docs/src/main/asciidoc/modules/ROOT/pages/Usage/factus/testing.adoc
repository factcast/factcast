...
In order to use the extension you either need to enable https://junit.org/junit5/docs/current/user-guide/#running-tests-build-maven-config-params[Junit-Extension-Autodetection], or use
...
xref:ROOT:Setup/properties.adoc[See Properties].
