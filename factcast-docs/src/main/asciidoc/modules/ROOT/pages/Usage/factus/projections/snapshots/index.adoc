...
The Key/Value store that keeps and maintains the snapshots is called a xref:ROOT:Usage/factus/projections/snapshots/snapshot-caching.adoc[SnapshotCache].
