...
A full example for both subscribed and managed projections can be found https://github.com/factcast/factcast/blob/main/factcast-examples/factcast-example-client-mongodb/src/main/java/org/factcast/example/client/mongodb/ExampleMongoDbClient.java[here].