...
Factus will look at these methods in order to discover xref:Concept/factspec.adoc#specification[fact specifications].
...
use the xref:callbacks.adoc#postprocess[`postprocess`] callback instead.
====
