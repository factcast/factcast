...
|factcast.grpc.client.enable-fast-forward|If the server supports it, enables fast forwarding. This is supposed to speedup frequent queries that gatther around the end of the gloabl Fact-Stream and thus can use dedicated indexes.|true|false
