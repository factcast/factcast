...
## [upcoming](https://github.com/Mercateo/factcast/tree/upcoming) (2019-06-23)
[Full Changelog](https://github.com/Mercateo/factcast/compare/factcast-0.1.0-RC4...upcoming)

**Closed issues:**

- Method names should not start with capital letters [\#459](https://github.com/Mercateo/factcast/issues/459)

## [factcast-0.1.0-RC4](https://github.com/Mercateo/factcast/tree/factcast-0.1.0-RC4) (2019-06-21)
[Full Changelog](https://github.com/Mercateo/factcast/compare/factcast-0.1.0-RC3...factcast-0.1.0-RC4)

**Implemented enhancements:**

- Fix initialization order of PG-Components [\#441](https://github.com/Mercateo/factcast/issues/441)

**Closed issues:**

- Extend GRPC Protocol with a call to fetch the current database-time [\#457](https://github.com/Mercateo/factcast/issues/457)
- Document CLI [\#428](https://github.com/Mercateo/factcast/issues/428)

**Merged pull requests:**

- added currentTimestamp\(\) to store interface [\#458](https://github.com/Mercateo/factcast/pull/458) ([uweschaefer](https://github.com/uweschaefer))
- Abstract filterScript to enable future extension with non-js scripts. [\#456](https://github.com/Mercateo/factcast/pull/456) ([uweschaefer](https://github.com/uweschaefer))
- Security: jackson databind vulnerability  [\#455](https://github.com/Mercateo/factcast/pull/455) ([uweschaefer](https://github.com/uweschaefer))
- Bump spring-boot-dependencies from 2.1.5.RELEASE to 2.1.6.RELEASE [\#454](https://github.com/Mercateo/factcast/pull/454) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump postgresql from 42.2.5 to 42.2.6 [\#453](https://github.com/Mercateo/factcast/pull/453) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump spring-boot-maven-plugin from 2.1.5.RELEASE to 2.1.6.RELEASE [\#452](https://github.com/Mercateo/factcast/pull/452) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump spotless-maven-plugin from 1.23.0 to 1.23.1 [\#451](https://github.com/Mercateo/factcast/pull/451) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump guava from 27.1-jre to 28.0-jre [\#449](https://github.com/Mercateo/factcast/pull/449) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- log as info. no need to log error within a working feature [\#448](https://github.com/Mercateo/factcast/pull/448) ([StephanPraetsch](https://github.com/StephanPraetsch))
- fixed grpc.client properties in examples and doc [\#446](https://github.com/Mercateo/factcast/pull/446) ([StephanPraetsch](https://github.com/StephanPraetsch))
- Bump mockito.version from 2.27.0 to 2.28.2 [\#444](https://github.com/Mercateo/factcast/pull/444) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump postgresql from 1.11.2 to 1.11.3 [\#439](https://github.com/Mercateo/factcast/pull/439) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
...
- Bump oss-parent-pom from 1.0.7 to 1.0.9 [\#435](https://github.com/Mercateo/factcast/pull/435) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
...
- Fix Spring Boot1 example dependencies [\#373](https://github.com/Mercateo/factcast/issues/373)
...
- Replace dropwizard Metrics by micrometer.io [\#210](https://github.com/Mercateo/factcast/issues/210)
...
- Bump spring-boot-maven-plugin from 2.1.4.RELEASE to 2.1.5.RELEASE [\#419](https://github.com/Mercateo/factcast/pull/419) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump spring-boot-starter-security from 2.1.4.RELEASE to 2.1.5.RELEASE [\#418](https://github.com/Mercateo/factcast/pull/418) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump spring-boot-dependencies from 2.1.4.RELEASE to 2.1.5.RELEASE [\#417](https://github.com/Mercateo/factcast/pull/417) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump jacoco-maven-plugin from 0.8.3 to 0.8.4 [\#416](https://github.com/Mercateo/factcast/pull/416) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
...
- Bump lombok from 1.18.6 to 1.18.8 [\#410](https://github.com/Mercateo/factcast/pull/410) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
...
- Bump spotless-maven-plugin from 1.22.0 to 1.23.0 [\#400](https://github.com/Mercateo/factcast/pull/400) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- \#397: removed markfacts from docs [\#399](https://github.com/Mercateo/factcast/pull/399) ([uweschaefer](https://github.com/uweschaefer))
- Issue390 [\#398](https://github.com/Mercateo/factcast/pull/398) ([uweschaefer](https://github.com/uweschaefer))
- WIP Issue395 [\#396](https://github.com/Mercateo/factcast/pull/396) ([uweschaefer](https://github.com/uweschaefer))
- \#251: removed marks [\#394](https://github.com/Mercateo/factcast/pull/394) ([uweschaefer](https://github.com/uweschaefer))
...
- Bump spring-boot-starter-security from 2.1.3.RELEASE to 2.1.4.RELEASE [\#389](https://github.com/Mercateo/factcast/pull/389) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- postgres module uuid-oosp documentation [\#388](https://github.com/Mercateo/factcast/pull/388) ([OOlsen](https://github.com/OOlsen))
- Bump spotless-maven-plugin from 1.21.1 to 1.22.0 [\#387](https://github.com/Mercateo/factcast/pull/387) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump postgresql from 1.11.1 to 1.11.2 [\#386](https://github.com/Mercateo/factcast/pull/386) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- \#140 lz4codec [\#385](https://github.com/Mercateo/factcast/pull/385) ([uweschaefer](https://github.com/uweschaefer))
- \#250-aggregate-validation-errors: aggregate validation errors [\#384](https://github.com/Mercateo/factcast/pull/384) ([uweschaefer](https://github.com/uweschaefer))
- \#382: oneliners [\#383](https://github.com/Mercateo/factcast/pull/383) ([uweschaefer](https://github.com/uweschaefer))
- \#234-gzip-compression-reenable: reenable gzip message compression [\#381](https://github.com/Mercateo/factcast/pull/381) ([uweschaefer](https://github.com/uweschaefer))
- \#370-macosx-hugo: script dispatching to respective binary [\#379](https://github.com/Mercateo/factcast/pull/379) ([uweschaefer](https://github.com/uweschaefer))
- \#55-basicauth: added basicauth [\#378](https://github.com/Mercateo/factcast/pull/378) ([uweschaefer](https://github.com/uweschaefer))
- pass along command line arguments to SpringApplication [\#376](https://github.com/Mercateo/factcast/pull/376) ([mweirauch](https://github.com/mweirauch))
- Bump mockito.version from 2.26.0 to 2.27.0 [\#375](https://github.com/Mercateo/factcast/pull/375) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
...
- Unify autoconfiguration [\#310](https://github.com/Mercateo/factcast/issues/310)

**Fixed bugs:**

- InMem FactCast doesn't support lastKnownEventId [\#307](https://github.com/Mercateo/factcast/issues/307)

**Closed issues:**

- Evaluate Coverage drop when updating to junit 5.4 [\#364](https://github.com/Mercateo/factcast/issues/364)
- Bump spring-grpc.version from 2.1.0.RELEASE to 2.3.0.RELEASE [\#355](https://github.com/Mercateo/factcast/issues/355)
- Add configuration option for spotless auto-apply [\#353](https://github.com/Mercateo/factcast/issues/353)
- fix version warnings for spring-maven-plugin  [\#351](https://github.com/Mercateo/factcast/issues/351)
- Update to latest grpc/netty deps [\#348](https://github.com/Mercateo/factcast/issues/348)
- Remove unique\_identifier [\#346](https://github.com/Mercateo/factcast/issues/346)
- Subtask to \#325: allow for state capturing independent of namespace [\#341](https://github.com/Mercateo/factcast/issues/341)
- Missing events due to race-condition during concurrent fact-publish [\#338](https://github.com/Mercateo/factcast/issues/338)
- Subtask to \#325: Extend GRPC protocol to support new methods on FactStore [\#331](https://github.com/Mercateo/factcast/issues/331)
- Subtask to \#325: Implement methods used by optimistic locking on PgFactStore [\#330](https://github.com/Mercateo/factcast/issues/330)
- Subtask to \#325: Implement Pg-based TokenStore [\#329](https://github.com/Mercateo/factcast/issues/329)
- Optimistic locking [\#325](https://github.com/Mercateo/factcast/issues/325)
- DepShield encountered errors while building your project [\#314](https://github.com/Mercateo/factcast/issues/314)
- Add --no-tls to CLI to connect using plaintext [\#270](https://github.com/Mercateo/factcast/issues/270)
- CLI: Exceptions when Options incomplete [\#268](https://github.com/Mercateo/factcast/issues/268)
- Drop Queued Catchup [\#264](https://github.com/Mercateo/factcast/issues/264)
- CLI: add switch to talk to TLS [\#245](https://github.com/Mercateo/factcast/issues/245)
- Extend API with prerequisites for optimistic locking [\#239](https://github.com/Mercateo/factcast/issues/239)
- store-pgsql: move auto-configuration out of module [\#214](https://github.com/Mercateo/factcast/issues/214)
- Consider formatting with spotless  [\#189](https://github.com/Mercateo/factcast/issues/189)

**Merged pull requests:**

- Bump junit-platform-commons from 1.4.1 to 1.4.2 [\#367](https://github.com/Mercateo/factcast/pull/367) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- \#issue353 :  minor change : fixed typo in bash script output only [\#366](https://github.com/Mercateo/factcast/pull/366) ([uweschaefer](https://github.com/uweschaefer))
- Issue364 upgrade to junit5 - coverage problem [\#365](https://github.com/Mercateo/factcast/pull/365) ([uweschaefer](https://github.com/uweschaefer))
- Bump junit-platform-engine from 1.4.0 to 1.4.2 [\#362](https://github.com/Mercateo/factcast/pull/362) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump junit-jupiter-engine from 5.3.2 to 5.4.2 [\#361](https://github.com/Mercateo/factcast/pull/361) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump spring-boot-maven-plugin from 2.1.3.RELEASE to 2.1.4.RELEASE [\#360](https://github.com/Mercateo/factcast/pull/360) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump junit-jupiter-api from 5.3.2 to 5.4.2 [\#359](https://github.com/Mercateo/factcast/pull/359) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump mockito.version from 2.25.1 to 2.26.0 [\#358](https://github.com/Mercateo/factcast/pull/358) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump spring-boot-dependencies from 2.1.3.RELEASE to 2.1.4.RELEASE [\#357](https://github.com/Mercateo/factcast/pull/357) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- \#355: Updated spring-grpc version [\#356](https://github.com/Mercateo/factcast/pull/356) ([uweschaefer](https://github.com/uweschaefer))
- Issue353 spotless auto-apply  [\#354](https://github.com/Mercateo/factcast/pull/354) ([uweschaefer](https://github.com/uweschaefer))
- Issue351 fix maven plugin version warnings [\#352](https://github.com/Mercateo/factcast/pull/352) ([uweschaefer](https://github.com/uweschaefer))
- Issue189 spotless [\#350](https://github.com/Mercateo/factcast/pull/350) ([uweschaefer](https://github.com/uweschaefer))
- Issue348 update to latest version of yidongnan/grpc-spring-boot-starter [\#349](https://github.com/Mercateo/factcast/pull/349) ([uweschaefer](https://github.com/uweschaefer))
- removed unique\_identifier feature [\#347](https://github.com/Mercateo/factcast/pull/347) ([uweschaefer](https://github.com/uweschaefer))
- Issue239 factstore extensions [\#345](https://github.com/Mercateo/factcast/pull/345) ([uweschaefer](https://github.com/uweschaefer))
- Issue338 transaction scoped locks [\#344](https://github.com/Mercateo/factcast/pull/344) ([uweschaefer](https://github.com/uweschaefer))
- \#341: add lockGlobally [\#343](https://github.com/Mercateo/factcast/pull/343) ([uweschaefer](https://github.com/uweschaefer))
- Issue331 - implement optimistic locking via GRPC [\#342](https://github.com/Mercateo/factcast/pull/342) ([uweschaefer](https://github.com/uweschaefer))
- Fix maven plugin configuration [\#340](https://github.com/Mercateo/factcast/pull/340) ([nln42](https://github.com/nln42))
- improved usage of xmllint [\#339](https://github.com/Mercateo/factcast/pull/339) ([nln42](https://github.com/nln42))
- add test to reproduce missing events in subscription [\#337](https://github.com/Mercateo/factcast/pull/337) ([fkissel](https://github.com/fkissel))
- Bump netty-tcnative-boringssl-static from 2.0.17.Final to 2.0.24.Final [\#336](https://github.com/Mercateo/factcast/pull/336) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Issue330: Implement optimistic locking aspect of PgFactStore [\#335](https://github.com/Mercateo/factcast/pull/335) ([uweschaefer](https://github.com/uweschaefer))
- Issue329 PgTokenStore [\#333](https://github.com/Mercateo/factcast/pull/333) ([uweschaefer](https://github.com/uweschaefer))
- Bump postgresql from 1.11.0 to 1.11.1 [\#328](https://github.com/Mercateo/factcast/pull/328) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump postgresql from 1.10.7 to 1.11.0 [\#327](https://github.com/Mercateo/factcast/pull/327) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- fix: class renamed, but not spring.factories [\#323](https://github.com/Mercateo/factcast/pull/323) ([uweschaefer](https://github.com/uweschaefer))
- Bump junit-jupiter-engine from 5.3.2 to 5.4.1 [\#322](https://github.com/Mercateo/factcast/pull/322) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump junit-jupiter-api from 5.3.2 to 5.4.1 [\#321](https://github.com/Mercateo/factcast/pull/321) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump mockito.version from 2.25.0 to 2.25.1 [\#320](https://github.com/Mercateo/factcast/pull/320) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump junit-platform-engine from 1.4.0 to 1.4.1 [\#319](https://github.com/Mercateo/factcast/pull/319) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump assertj-core from 3.12.1 to 3.12.2 [\#318](https://github.com/Mercateo/factcast/pull/318) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Remove rest from site [\#317](https://github.com/Mercateo/factcast/pull/317) ([uweschaefer](https://github.com/uweschaefer))
- Cleanup pg prefixes on classnames depends on pr315 [\#316](https://github.com/Mercateo/factcast/pull/316) ([uweschaefer](https://github.com/uweschaefer))
- Issue310 autoconfiguration [\#315](https://github.com/Mercateo/factcast/pull/315) ([uweschaefer](https://github.com/uweschaefer))
- Bump postgresql from 1.10.6 to 1.10.7 [\#313](https://github.com/Mercateo/factcast/pull/313) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump guava from 27.0.1-jre to 27.1-jre [\#309](https://github.com/Mercateo/factcast/pull/309) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Fix catchup with startingFrom-FactId [\#308](https://github.com/Mercateo/factcast/pull/308) ([uweschaefer](https://github.com/uweschaefer))
- Bump mockito.version from 2.24.5 to 2.25.0 [\#306](https://github.com/Mercateo/factcast/pull/306) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump spring-cloud-dependencies from Greenwich.RELEASE to Greenwich.SR1 [\#305](https://github.com/Mercateo/factcast/pull/305) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump assertj-core from 3.12.0 to 3.12.1 [\#303](https://github.com/Mercateo/factcast/pull/303) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump grpc.version from 1.18.0 to 1.19.0 [\#302](https://github.com/Mercateo/factcast/pull/302) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Update pom.xml [\#301](https://github.com/Mercateo/factcast/pull/301) ([uweschaefer](https://github.com/uweschaefer))
- Bump mockito.version from 2.24.0 to 2.24.5 [\#300](https://github.com/Mercateo/factcast/pull/300) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump junit-jupiter-engine from 5.3.2 to 5.4.0 [\#299](https://github.com/Mercateo/factcast/pull/299) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump slf4j-api.version from 1.7.25 to 1.7.26 [\#298](https://github.com/Mercateo/factcast/pull/298) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump junit-jupiter-api from 5.3.2 to 5.4.0 [\#297](https://github.com/Mercateo/factcast/pull/297) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump lombok from 1.18.4 to 1.18.6 [\#296](https://github.com/Mercateo/factcast/pull/296) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump assertj-core from 3.11.1 to 3.12.0 [\#295](https://github.com/Mercateo/factcast/pull/295) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump os-maven-plugin from 1.6.1 to 1.6.2 [\#294](https://github.com/Mercateo/factcast/pull/294) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump spring-grpc.version from 2.1.0.RELEASE to 2.2.1.RELEASE [\#293](https://github.com/Mercateo/factcast/pull/293) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump spring-boot-maven-plugin from 1.5.17.RELEASE to 2.1.3.RELEASE [\#292](https://github.com/Mercateo/factcast/pull/292) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump spring-boot-dependencies from 2.1.1.RELEASE to 2.1.3.RELEASE [\#291](https://github.com/Mercateo/factcast/pull/291) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump junit-platform-engine from 1.3.2 to 1.4.0 [\#290](https://github.com/Mercateo/factcast/pull/290) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump mockito.version from 2.23.4 to 2.24.0 [\#289](https://github.com/Mercateo/factcast/pull/289) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump liquibase-core from 3.6.2 to 3.6.3 [\#288](https://github.com/Mercateo/factcast/pull/288) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump postgresql from 1.10.5 to 1.10.6 [\#287](https://github.com/Mercateo/factcast/pull/287) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump jacoco-maven-plugin from 0.8.2 to 0.8.3 [\#286](https://github.com/Mercateo/factcast/pull/286) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump spring-cloud-dependencies from Finchley.SR2 to Greenwich.RELEASE [\#285](https://github.com/Mercateo/factcast/pull/285) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump grpc.version from 1.17.1 to 1.18.0 [\#284](https://github.com/Mercateo/factcast/pull/284) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump oss-parent-pom from 1.0.6 to 1.0.7 [\#281](https://github.com/Mercateo/factcast/pull/281) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump oss-parent-pom from 1.0.5 to 1.0.6 [\#280](https://github.com/Mercateo/factcast/pull/280) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump postgresql from 1.10.4 to 1.10.5 [\#279](https://github.com/Mercateo/factcast/pull/279) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump postgresql from 1.10.3 to 1.10.4 [\#278](https://github.com/Mercateo/factcast/pull/278) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump maven-failsafe-plugin from 3.0.0-M2 to 3.0.0-M3 [\#277](https://github.com/Mercateo/factcast/pull/277) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump maven-surefire-plugin from 3.0.0-M2 to 3.0.0-M3 [\#276](https://github.com/Mercateo/factcast/pull/276) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump postgresql from 1.10.2 to 1.10.3 [\#274](https://github.com/Mercateo/factcast/pull/274) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump jackson-databind from 2.9.7 to 2.9.8 [\#273](https://github.com/Mercateo/factcast/pull/273) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- \#270: added --no-tls [\#271](https://github.com/Mercateo/factcast/pull/271) ([uweschaefer](https://github.com/uweschaefer))
- print usage when cli options incomplete [\#269](https://github.com/Mercateo/factcast/pull/269) ([leflamm](https://github.com/leflamm))
- Bump maven-surefire-plugin from 3.0.0-M1 to 3.0.0-M2 [\#267](https://github.com/Mercateo/factcast/pull/267) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump maven-failsafe-plugin from 3.0.0-M1 to 3.0.0-M2 [\#266](https://github.com/Mercateo/factcast/pull/266) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- \#264: removed queued catchup strategy [\#265](https://github.com/Mercateo/factcast/pull/265) ([uweschaefer](https://github.com/uweschaefer))
- Bump grpc.version from 1.16.1 to 1.17.0 [\#262](https://github.com/Mercateo/factcast/pull/262) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
...
- Bump spring-boot-dependencies from 2.1.0.RELEASE to 2.1.1.RELEASE [\#259](https://github.com/Mercateo/factcast/pull/259) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump postgresql from 1.10.1 to 1.10.2 [\#257](https://github.com/Mercateo/factcast/pull/257) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump junit-jupiter-api from 5.3.1 to 5.3.2 [\#256](https://github.com/Mercateo/factcast/pull/256) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump junit-platform-engine from 1.3.1 to 1.3.2 [\#255](https://github.com/Mercateo/factcast/pull/255) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump junit-jupiter-engine from 5.3.1 to 5.3.2 [\#253](https://github.com/Mercateo/factcast/pull/253) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
...
- Bump mockito.version from 2.23.0 to 2.23.4 [\#237](https://github.com/Mercateo/factcast/pull/237) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
...
- Bump guava from 27.0-jre to 27.0.1-jre [\#233](https://github.com/Mercateo/factcast/pull/233) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- fixed empty catch block [\#232](https://github.com/Mercateo/factcast/pull/232) ([uweschaefer](https://github.com/uweschaefer))
- Bump docker-maven-plugin from 0.4.9 to 1.2.0 [\#230](https://github.com/Mercateo/factcast/pull/230) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump guava from 26.0-jre to 27.0-jre [\#229](https://github.com/Mercateo/factcast/pull/229) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump slf4j-api from 1.7.22 to 1.7.25 [\#228](https://github.com/Mercateo/factcast/pull/228) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump protobuf-maven-plugin from 0.5.1 to 0.6.1 [\#227](https://github.com/Mercateo/factcast/pull/227) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
...
- Bump build-helper-maven-plugin from 1.8 to 3.0.0 [\#223](https://github.com/Mercateo/factcast/pull/223) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump postgresql from 42.2.5.jre7 to 42.2.5 [\#222](https://github.com/Mercateo/factcast/pull/222) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump assertj-core from 2.6.0 to 3.11.1 [\#221](https://github.com/Mercateo/factcast/pull/221) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump oss-parent-pom from 1.0.0 to 1.0.4 [\#220](https://github.com/Mercateo/factcast/pull/220) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
- Bump os-maven-plugin from 1.4.1.Final to 1.6.1 [\#219](https://github.com/Mercateo/factcast/pull/219) ([dependabot-preview[bot]](https://github.com/apps/dependabot-preview))
