...
`org.xerial.snappy` and `net.jpountz.lz4` have been removed with version 0.8.0. If you still use these dependencies
please switch to the new `factcast-grpc-snappy` and `factcast-grpc-lz4` dependencies respectively.
