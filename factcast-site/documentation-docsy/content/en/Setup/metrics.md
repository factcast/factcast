...
| tailIndices                | `meter` | Counts the number of tail indices being present after tail index maintenance. They have a "state" tag whic can be used to distinguish between valid/invalid ones.                                                                                                                                                                                                                                                                                                 |
