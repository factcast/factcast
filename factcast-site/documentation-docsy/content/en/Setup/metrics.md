...
|-------------------------|---------|----------------------------------|
| handshake               | `timer` | Duration of the GRPC handshakes. |
...
| notifyRoundTripLatency     | `timer` | Time to receive an answer from the DB during connection validation (roundtrip).                                                                                                                                                                                                                                                                                                                                                                                   |
...
| catchupTransformationRatio | `meter` | Percentage of facts transformed (downcasted/upcasted) by the server in response to a subscribed client. Useful for debugging the amount of overhead due to transforming, for subscription returning a significant amount of facts.<br />Ref: [transformation](/concept/transformation)                                                                                                                                                                            |
