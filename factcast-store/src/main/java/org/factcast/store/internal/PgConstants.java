...
public class PgConstants {
  ...
  public static final String LISTEN_BLACKLIST_CHANGE_CHANNEL_SQL = "LISTEN " + CHANNEL_BLACKLIST_CHANGE;

  public static final String LISTEN_SCHEMASTORE_CHANGE_CHANNEL_SQL = "LISTEN " + CHANNEL_SCHEMASTORE_CHANGE;

  public static final String LISTEN_TRANSFORMATIONSTORE_CHANGE_CHANNEL_SQL = "LISTEN " + CHANNEL_TRANSFORMATIONSTORE_CHANGE;
