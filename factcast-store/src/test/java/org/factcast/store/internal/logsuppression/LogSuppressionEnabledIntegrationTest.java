...
@TestPropertySource(
    properties = {
      ...
      "factcast.store.log-suppression.enabled=true",
      "factcast.store.log-suppression.threshold=1",
      "factcast.store.log-suppression.sampling=0",
    })
class LogSuppressionEnabledIntegrationTest {
