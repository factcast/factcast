...
class AbstractPgCatchupTest {
  ...
  private static class DummyCatchup extends AbstractPgCatchup {
    public DummyCatchup(
        ...
        AtomicLong serial,
        CurrentStatementHolder statementHolder,
        DataSource ds,
  ...
  void setsFastForward() {
    DummyCatchup catchup =
        new DummyCatchup(props, metrics, req, pipeline, serial, statementHolder, ds, phase);
  ...
  void nullValidations() {
    assertThrows(
        ...
        () -> new DummyCatchup(null, metrics, req, pipeline, serial, statementHolder, ds, phase));
    assertThrows(
        NullPointerException.class,
        () -> new DummyCatchup(props, null, req, pipeline, serial, statementHolder, ds, phase));
    assertThrows(
        NullPointerException.class,
        () -> new DummyCatchup(props, metrics, null, pipeline, serial, statementHolder, ds, phase));
    assertThrows(
        NullPointerException.class,
        () -> new DummyCatchup(props, metrics, req, null, serial, statementHolder, ds, phase));
    assertThrows(
        NullPointerException.class,
        () -> new DummyCatchup(props, metrics, req, pipeline, null, statementHolder, ds, phase));
    assertThrows(
        NullPointerException.class,
    ...
    assertThrows(
        NullPointerException.class,
        () ->
            new DummyCatchup(props, metrics, req, pipeline, serial, statementHolder, null, phase));
    assertThrows(
        NullPointerException.class,
        () -> new DummyCatchup(props, metrics, req, pipeline, serial, statementHolder, ds, null));
  }
}
