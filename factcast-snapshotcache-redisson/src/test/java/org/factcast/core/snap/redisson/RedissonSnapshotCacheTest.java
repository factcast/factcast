...
class RedissonSnapshotCacheTest {
  ...
  //    @Test
  //    void testGetNull() {
  //      assertThat(underTest.find(SnapshotId.of("foo", UUID.randomUUID()))).isEmpty();
  //    }
  //
  //    @Test
  //    void testGetPojo() {
  ...
  //      underTest.store(snap);
  //
  //      assertThat(underTest.find(id)).isNotEmpty().hasValue(snap);
  //    }
  //  }
  //
  //  @Nested
  ...
  //
  //      underTest.store(snap1);
  //      sleep(2000);
  //      underTest.store(snap2);
  ...
  //
  //      argument.getAllValues().forEach(codec ->
  // assertThat(codec).isInstanceOf(Kryo5Codec.class));
  //    }
  //  }
}
