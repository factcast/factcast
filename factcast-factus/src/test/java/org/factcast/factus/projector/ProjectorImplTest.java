...
class ProjectorImplTest {
  ...
  //            SimpleEvent event =
  //                    new SimpleEvent(Maps.newHashMap("Some key", "Some value"), aggregateId,
  // "abc");
  //
  ...
  //
  //            ProjectorImpl<SimpleProjection> underTest = new ProjectorImpl<>(eventSerializer,
  // projection);
  //
  //            // RUN
  ...
  //
  //            ComplexEvent event =
  //                    new ComplexEvent(Maps.newHashMap("Some key", "Some value"), aggregateId,
  // "abc");
  //            ComplexEvent2 event2 =
  //                    new ComplexEvent2(Maps.newHashMap("Some key", "Some other value"),
  // aggregateId2, "def");
  //
  //            Fact fact = eventConverter.toFact(event);
  ...
  //
  //            ProjectorImpl<ComplexProjection> underTest = new ProjectorImpl<>(eventSerializer,
  // projection);
  //
  //            // RUN
  //            underTest.apply(fact);
  ...
  //            SimpleProjectionWithStaticSubclass projection = new
  // SimpleProjectionWithStaticSubclass();
  //
  ...
  //
  //            Fact fact =
  // Fact.builder().ns("test").type("someType").id(factId).aggId(aggId).build("{}");
  //
  ...
  ////
  ////            ProjectorImpl<ComplexAggregate> underTest = new ProjectorImpl<>(eventSerializer,
  // projection);
  ////
  ////            // RUN
  ...
  ////                    .hasSize(2)
  ////                    .flatExtracting(FactSpec::aggId, FactSpec::ns, FactSpec::version,
  // FactSpec::type)
  ////                    .contains(
  ////                            // ComplexProjection has two handlers
  ////                            null, "test", 0, "ComplexEvent", null, "test", 0,
  // "ComplexEvent2");
  ////        }
  //
  //        @Test
  ...
  //                            aggregateId, "test", 0, "ComplexEvent", aggregateId, "test", 0,
  // "ComplexEvent2");
  //        }
  //
  //        @Test
  ...
  //                    new ProjectorImpl<>(
  //                            eventSerializer, new
  // PostProcessingProjection(Collections.emptyList()));
  //
  //            // RUN
  //            assertThatThrownBy(() -> underTest.createFactSpecs())
  //                    // ASSERT
  ...
  //            // INIT / RUN
  //            assertThatThrownBy(
  //                    () -> new ProjectorImpl<>(eventSerializer, new
  // DuplicateHandlerProjection()))
  //                    // ASSERT
  //                    .isInstanceOf(InvalidHandlerDefinition.class)
  ...
  //            // INIT / RUN
  //            assertThatThrownBy(() -> new ProjectorImpl<>(eventSerializer, new
  ...
  //            assertThatThrownBy(
  //                    () -> new ProjectorImpl<>(eventSerializer, new
  // HandlerWithUnknownParameterType()))
  //                    // ASSERT
  //                    .isInstanceOf(InvalidHandlerDefinition.class)
  ...
  //                            () -> {
  //                                Fact f1 =
  // Fact.builder().ns("ns").type("type").version(1).buildWithoutPayload();
  //                                Fact f2 =
  // Fact.builder().ns("ns").type("type").version(2).buildWithoutPayload();
  //
  //                                p.apply(f1);
  //                                p.apply(f2);
  //                            });
  ...
  //            assertThat(ReflectionTools.resolveTargetObject(ProjectorImplTest.this,
  ...
  ////            Method realMethod = NonStaticClass.class.getDeclaredMethod("apply",
  // SimpleEvent.class);
  ...
  ////            Method realMethod =
  ////                    NonStaticClass$MockitoMock.class.getDeclaredMethod("apply",
  // SimpleEvent.class);
  ...
  //                            });
  //            ProjectorImpl<Projection> underTest =
  //                    new ProjectorImpl<>(mock(EventSerializer.class),
  // notFactStreamPositionAware);
  //
  //            UUID id = UUID.randomUUID();
  //            underTest.onCatchup(id);
  //
  ...
  //        Method m = HandlerMethdsWithAdditionalFilters.class.getMethod("applyWithOneMeta",
  // Fact.class);
  ...
  //        FactSpec spec = FactSpec.ns("ns");
  //        Method m = HandlerMethdsWithAdditionalFilters.class.getMethod("applyWithMultiMeta",
  // Fact.class);
  //        ProjectorImpl.ReflectionTools.addOptionalFilterInfo(m, spec);
  //
  //        assertThat(spec.meta()).containsEntry("foo", "bar");
  ...
  //        FactSpec spec = FactSpec.ns("ns");
  //        Method m = HandlerMethdsWithAdditionalFilters.class.getMethod("applyWithAggId",
  // Fact.class);
  //        ProjectorImpl.ReflectionTools.addOptionalFilterInfo(m, spec);
  //
  //
  ...
  //        FactSpec spec = FactSpec.ns("ns");
  //        Method m =
  //                HandlerMethdsWithAdditionalFilters.class.getMethod("applyWithFilterScript",
  // Fact.class);
  //        ProjectorImpl.ReflectionTools.addOptionalFilterInfo(m, spec);
  //
