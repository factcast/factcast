...
class FactusImplTest {
  ...
  //
  //  @Spy private final FactusMetrics factusMetrics = new FactusMetricsImpl(new
  // SimpleMeterRegistry());
  //
  //  @InjectMocks private FactusImpl underTest;
  //
  //  @Captor ArgumentCaptor<StreamObserver> factObserverCaptor;
  //
  ...
  //
  //      assertThatJson(factCaptor.getValue().jsonPayload()).and(f ->
  // f.node("val").isEqualTo("a"));
  //    }
  //
  //    @Test
  ...
  //          .anySatisfy(
  //              fact -> assertThatJson(fact.jsonPayload()).and(f ->
  // f.node("val").isEqualTo("b")));
  //    }
  //
  //    @Test
  ...
  //      ArgumentCaptor<StreamObserver> observer = ArgumentCaptor.forClass(StreamObserver.class);
  //
  ...
  //          .thenAnswer(
  //              inv -> {
  //                StreamObserver obs = observer.getValue();
  //                obs.onNext(f1);
  //                obs.onNext(f2);
  //
  ...
  //          .thenAnswer(
  //              inv -> {
  //                StreamObserver factObserver = factObserverCaptor.getValue();
  //
  ...
  //      when(projector.createFactSpecs()).thenReturn(specs);
  //
  //      when(fc.subscribe(any(),
  // factObserverCaptor.capture())).thenReturn(mock(Subscription.class));
  //
  //      // prepare deserialiser for existing snapshot
  ...
  //
  //    @Captor ArgumentCaptor<StreamObserver> factObserverArgumentCaptor;
  ...
  //
  //      StreamObserver factObserver = factObserverArgumentCaptor.getValue();
  //
  ...
  //
  //      // RUN
  //      SomeSnapshotProjection personAggregateResult =
  // underTest.fetch(SomeSnapshotProjection.class);
  //
